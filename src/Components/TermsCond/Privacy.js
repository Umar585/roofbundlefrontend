    ...
    <div>
      <div className="container pt-4 pb-4">
        ...
        <p className="mt-2 mb-2">
          Peters Build Inc ("us", "we", or "our") operates{" "}
          <a href="http://www.roofbundle.ca">http://www.roofbundle.ca</a> (the
        ...
        <p className="mt-2 mb-2">
          This Privacy Policy is effective as of December 20, 2020 and will
