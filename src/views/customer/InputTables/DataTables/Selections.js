    ...
    <div>
      <div className="row no-gutters">
        ...
        <div className="col-6 mb-1 gb-pl">
          <select
            className="form-control"
            id="ice_water_protection_two"
            name="ice_water_protection_two"
            style={inputStyle}
            value={form.ice_water_protection_two}
            onChange={(e) =>
              setForm({
                ...form,
                ice_water_protection_two: e.target.value,
              })
            }
          >
            <option value="">Ice & Water</option>
